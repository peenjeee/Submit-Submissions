...
categories.name AS category_name, jobs.company_id, jobs.category_id,
jobs.description, jobs.job_type, jobs.experience_level, jobs.location_type,
jobs.location_city, jobs.salary_min, jobs.salary_max, jobs.is_salary_visible,
jobs.status
FROM bookmarks
